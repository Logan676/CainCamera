...
/** Shake effect similar to TikTok */
class GLImageEffectShakeFilter : GLImageEffectFilter {
    ...
    private constructor(context: Context, vertexShader: String, fragmentShader: String) :
